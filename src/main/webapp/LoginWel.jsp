...
<div class="login" id="signup" >
	...
	<h4>Login Option</h4>
	<hr>
	<a type="button" class="btn btn-primary btn-block btn-large" href="UserLoginPage.jsp">
		<button type="button" class="btn btn-primary btn-block btn-large">Retail...</button>
	</a>
    	
    <br>
    <a type="button" class="btn btn-primary btn-block btn-large" href="costumerLogin.jsp">
    	<button type="button" class="btn btn-primary btn-block btn-large">customer..</button>
    </a>
    <br>	
</div>
